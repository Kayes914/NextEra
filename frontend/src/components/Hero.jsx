      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4 sm:px-0">
            ...
            <motion.a 
              href="/contact" 
              className="px-8 py-4 border-2 border-[#00D1FF] text-[#00D1FF] font-semibold rounded-full hover:bg-[#00D1FF]/10 transition-all duration-300 transform hover:-translate-y-1"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Get Started
